...
class CustomDataset(Dataset):
    ...
    def __init__(self, df, cfg, aug, mode='train', allowed_targets=None):
        ...
        if (mode == 'val') & ('landmark_id' not in self.df.columns):       
        ...
        print(self.df.head())
        print(self.df['target'].min(),self.df['target'].max(),self.df['target'].nunique())            
