    ...
    for epoch in range(cfg.epochs):
        ...
        if cfg.train:
            ...
            for itr in progress_bar:
                ...
                local_loss = output_dict["local_loss"]
                
                freeze_weights(model,freeze=['localmodel', 'att_cls'])
                ...
                freeze_weights(model,freeze=['globalmodel', 'head']) 
                unfreeze_weights(model,freeze=['localmodel', 'att_cls'])
                
                scaler.scale(local_loss).backward()
                    
                unfreeze_weights(model, freeze=['globalmodel', 'head'])    
