...
class Net(nn.Module):
    def __init__(self, cfg, dataset):
        ...
        self.backbone.patch_embed = PatchEmbed(img_size=(cfg.img_size[0],cfg.img_size[1]), 
                patch_size=(self.backbone.patch_embed.patch_size[0]*2,self.backbone.patch_embed.patch_size[1]*2), 
                in_chans=self.cfg.in_channels, 
                embed_dim=self.backbone.embed_dim,
            norm_layer=nn.LayerNorm if self.backbone.patch_norm else None)
