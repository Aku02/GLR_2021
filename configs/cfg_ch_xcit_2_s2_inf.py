...
cfg.output_dir = f"/mount/glr2021/models/cfg_ch_xcit_2_s2/"
...
cfg.backbone = "xcit_medium_24_p16_224_dist"
cfg.find_unused_parameters = True
cfg.neck = "option-D"
cfg.embedding_size = 512
cfg.pool = "gem"
cfg.gem_p_trainable = True
cfg.pretrained_weights = '/mount/glr2021/models/cfg_ch_xcit_2_s2/fold0/checkpoint_last_seed622457.pth'
...
# bash distributed_train.sh 8 -C cfg_ch_xcit_2_s2_inf && bash distributed_train.sh 8 -C cfg_ch_xcit_2_s2_inf --train_df /mount/glr2021/data/2019/train_gldv2c.csv --pre_train_val tr_gldv2c && bash distributed_train.sh 8 -C cfg_ch_xcit_2_s2_inf --train_df /mount/glr2021/data/2019/train_gldv2x_no_c.csv --pre_train_val tr_gldv2x_no_c && bash distributed_train.sh 8 -C cfg_ch_xcit_2_s2_inf --train_df /mount/glr2021/data/wit/train_gldv2c_wit_v2c.csv --pre_train_val tr_gldv2_wit_v2c
