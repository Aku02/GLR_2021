...
cfg.output_dir = f"/mount/glr2021/models/cfg_ch_dolg_5_s2x/"
...
cfg.pretrained_weights = '/mount/glr2021/models/cfg_ch_dolg_5_s2x/fold0/checkpoint_last_seed826111.pth'
...
# --train_df /mount/glr2021/data/2019/train_gldv2_wit_v2c.csv --pre_train_val tr_gldv2_wit_v2c
