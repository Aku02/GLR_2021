...
cfg.output_dir = f"/mount/glr2021/models/cfg_ch_dolg_2_2head_s2/"
cfg.val_data_folder = "/raid/landmark-recognition-2019/" + "test/"

# cfg.test = "/mount/glr2021/data/2019/train_gldv2x_no_c.csv"
# cfg.test_data_folder = cfg.data_dir + "train/"
...
cfg.pretrained_weights = '/mount/glr2021/models/cfg_ch_dolg_2_2head_s2/fold0/checkpoint_last_seed864909.pth'
