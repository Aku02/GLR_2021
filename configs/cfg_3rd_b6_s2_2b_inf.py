...
cfg.output_dir = f"/mount/glr2021/models/cfg_3rd_b6_s2_2b/"
...
cfg.train_df = "/mount/glr2021/data/wit/wit_v3c.csv"
cfg.pre_train_val = "wit_v3c"
cfg.pretrained=False
cfg.epochs = 1
cfg.train = False
cfg.val = False
...
# bash distributed_train.sh 8 -C cfg_3rd_b6_s2_2b_inf --train_df /mount/glr2021/data/2019/index_image_to_landmark.csv --pre_train_val index_2019 --data_folder /raid/landmark-recognition-2019/index/