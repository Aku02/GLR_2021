...
cfg.val_df = cfg.train_df
cfg.output_dir = f"/mount/glr2021/models/{os.path.basename(__file__).split('.')[0]}"
cfg.val_data_folder = "/raid/landmark-recognition-2019/" + "train/"
...
cfg.headless = True
cfg.pretrained_weights = '/mount/glr2021/models/cfg_ch_6c/fold0/checkpoint_last_seed192164.pth'
