...
cfg.train_df = "/mount/glr2021/data/2019/train_gldv2_min2.csv"
...
cfg.pretrained_weights = '/mount/glr2021/models/cfg_ch_dolg_2/fold0/checkpoint_last_seed483019.pth'
cfg.pretrained_weights_strict = False
# DATASET
cfg.dataset = "ch_ds_4"
cfg.normalization = 'imagenet'
cfg.landmark_id2class_id = pd.read_csv('/mount/glr2021/data/2019/landmark_id2class_gldv2_min2.csv')
cfg.num_workers = 8
# cfg.data_sample = 100000
cfg.loss = 'adaptive_arcface'
cfg.arcface_s = 45
cfg.arcface_m = 0.3
cfg.n_classes = 184200
