...
cfg.output_dir = f"/mount/glr2021/models/cfg_ch_dolg_5_s3x_1/"
...
cfg.pretrained_weights = '/mount/glr2021/models/cfg_ch_dolg_5_s3x_1/fold0/checkpoint_last_seed578140.pth'
cfg.pretrained_weights_strict = True
cfg.pretrained = False
# DATASET
cfg.dataset = "ch_ds_4c"
...
# --train_df /mount/glr2021/data/wit/wit_v3c.csv --pre_train_val wit_v3c
# --train_df /mount/glr2021/data/wit/wit_v3_no_x.csv --pre_train_val wit_v3_no_x
# --train_df /mount/glr2021/data/2019/index2019_remapped.csv --pre_train_val index2019_remapped --data_folder /raid/landmark-recognition-2019/index/
# --train_df /mount/glr2021/data/wit/wit_v4.csv --pre_train_val wit_v4

# bash distributed_train.sh 8 -C cfg_ch_dolg_5_s3x_1_inf --train_df /mount/glr2021/data/wit/wit_v3c.csv --pre_train_val wit_v3c && bash distributed_train.sh 8 -C cfg_ch_dolg_5_s3x_1_inf --train_df /mount/glr2021/data/wit/wit_v3_no_x.csv --pre_train_val wit_v3_no_x && bash distributed_train.sh 8 -C cfg_ch_dolg_5_s3x_1_inf --train_df /mount/glr2021/data/2019/index2019_remapped.csv --pre_train_val index2019_remapped --data_folder /raid/landmark-recognition-2019/index/ && bash distributed_train.sh 8 -C cfg_ch_dolg_5_s3x_1_inf --train_df /mount/glr2021/data/wit/wit_v4.csv --pre_train_val wit_v4
