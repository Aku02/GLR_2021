...
cfg.output_dir = f"/mount/glr2021/models/cfg_ch_dolg_2_2head_s2z5/"
...
cfg.pretrained_weights = '/mount/glr2021/models/cfg_ch_dolg_2_2head_s2z5/fold0/checkpoint_last_seed332935.pth'
cfg.pretrained_weights_strict = True
cfg.pretrained=False
# DATASET
cfg.dataset = "ch_ds_4b"
cfg.normalization = 'imagenet'
cfg.landmark_id2class_id = pd.read_csv('/mount/glr2021/data/2019/landmark_id2class_gldv2z5.csv')
cfg.num_workers = 8
...
# --train_df /mount/glr2021/data/2019/train_gldv2x_no_c.csv --pre_train_val train_gldv2x_no_c
