...
cfg.output_dir = f"/mount/glr2021/models/cfg_ch_hybrid_swin224_2x_b5_cutout_s2x/"
...
# MODEL
cfg.model = "ch_mdl_hybrid_transformer_2x_2"
...
# bash distributed_train.sh 8 -C cfg_ch_hybrid_swin224_2x_b5_cutout_s2x_inf && bash distributed_train.sh 8 -C cfg_ch_hybrid_swin224_2x_b5_cutout_s2x_inf --train_df /mount/glr2021/data/2019/train_gldv2c.csv --pre_train_val tr_gldv2c && bash distributed_train.sh 8 -C cfg_ch_hybrid_swin224_2x_b5_cutout_s2x_inf --train_df /mount/glr2021/data/2019/train_gldv2x_no_c.csv --pre_train_val tr_gldv2x_no_c && bash distributed_train.sh 8 -C cfg_ch_hybrid_swin224_2x_b5_cutout_s2x_inf --train_df /mount/glr2021/data/wit/wit_v2c.csv --pre_train_val wit_v2c && bash distributed_train.sh 8 -C cfg_ch_hybrid_swin224_2x_b5_cutout_s2x_inf --train_df /mount/glr2021/data/wit/wit_v3c.csv --pre_train_val wit_v3c && bash distributed_train.sh 8 -C cfg_ch_hybrid_swin224_2x_b5_cutout_s2x_inf --train_df /mount/glr2021/data/wit/wit_v3_no_x.csv --pre_train_val wit_v3_no_x && bash distributed_train.sh 8 -C cfg_ch_hybrid_swin224_2x_b5_cutout_s2x_inf --train_df /mount/glr2021/data/2019/index2019_remapped.csv --pre_train_val index2019_remapped --data_folder /raid/landmark-recognition-2019/index/
