...
cfg.output_dir = f"/mount/glr2021/models/cfg_ch_dolg_2_2head_s2b/"
...
# bash distributed_train.sh 8 -C cfg_ch_dolg_2_2head_s2b_inf --train_df /mount/glr2021/data/wit/wit_v3c.csv --pre_train_val wit_v3c && bash distributed_train.sh 8 -C cfg_ch_dolg_2_2head_s2b_inf --train_df /mount/glr2021/data/wit/wit_v3_no_x.csv --pre_train_val wit_v3_no_x && bash distributed_train.sh 8 -C cfg_ch_dolg_2_2head_s2b_inf --train_df /mount/glr2021/data/2019/index2019_remapped.csv --pre_train_val index2019_remapped --data_folder /raid/landmark-recognition-2019/index/ 
