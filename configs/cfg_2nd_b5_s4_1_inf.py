...
cfg.output_dir = f"/mount/glr2021/models/cfg_2nd_b5_s4_1/"
...
# --train_df /mount/glr2021/data/2019/train_gldv2_no_x.csv --pre_train_val tr_gldv2_no_x
#bash distributed_train.sh 8 -C cfg_2nd_b5_s4_1_inf --train_df /mount/glr2021/data/wit/wit_v3c.csv --pre_train_val wit_v3c && bash distributed_train.sh 8 -C cfg_2nd_b5_s4_1_inf --train_df /mount/glr2021/data/wit/wit_v3_no_x.csv --pre_train_val wit_v3_no_x && bash distributed_train.sh 8 -C cfg_2nd_b5_s4_1_inf --train_df /mount/glr2021/data/2019/index2019_remapped.csv --pre_train_val index2019_remapped --data_folder /raid/landmark-recognition-2019/index/
