...
cfg.output_dir = f"/mount/glr2021/models/cfg_ch_dolg_2_s3x/"
...
cfg.pretrained_weights = '/mount/glr2021/models/cfg_ch_dolg_2_s3x/fold0/checkpoint_last_seed218785.pth'
