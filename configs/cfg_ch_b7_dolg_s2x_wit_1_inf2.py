...
cfg.output_dir = f"/mount/glr2021/models/cfg_ch_b7_dolg_s2x_wit_1/"
...
cfg.pretrained_weights = '/mount/glr2021/models/cfg_ch_b7_dolg_s2x_wit_1/fold0/checkpoint_last_seed672936.pth'
