...
cfg.output_dir = f"/mount/glr2021/models/cfg_3rd_b3_s3_2/"
...
cfg.pretrained_weights = '/mount/glr2021/models/glr2020-3rd-place/b3/weights/b3ns_final_768_300w_f1_load29_10ep_fold-1_e10_headless.pth'
...
## bash distributed_train.sh 8 -C cfg_3rd_b3_s3_2_inf && bash distributed_train.sh 8 -C cfg_3rd_b3_s3_2_inf --train_df /mount/glr2021/data/2019/train_gldv2c.csv --pre_train_val tr_gldv2c && bash distributed_train.sh 8 -C cfg_3rd_b3_s3_2_inf --train_df /mount/glr2021/data/2019/train_gldv2x_no_c.csv --pre_train_val tr_gldv2x_no_c && bash distributed_train.sh 8 -C cfg_3rd_b3_s3_2_inf --train_df /mount/glr2021/data/wit/wit_v2c.csv --pre_train_val wit_v2c && bash distributed_train.sh 8 -C cfg_3rd_b3_s3_2_inf --train_df /mount/glr2021/data/wit/wit_v3c.csv --pre_train_val wit_v3c && bash distributed_train.sh 8 -C cfg_3rd_b3_s3_2_inf --train_df /mount/glr2021/data/wit/wit_v3_no_x.csv --pre_train_val wit_v3_no_x && bash distributed_train.sh 8 -C cfg_3rd_b3_s3_2_inf --train_df /mount/glr2021/data/2019/index2019_remapped.csv --pre_train_val index2019_remapped --data_folder /raid/landmark-recognition-2019/index/
